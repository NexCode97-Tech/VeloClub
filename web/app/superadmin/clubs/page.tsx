    ...
    <div ref={ref} style={{ position: 'relative' }}>
      ...
      <motion.button
        ...
        style={{
          ...
          background: '#fff', fontFamily: 'Carlito, sans-serif',
    ...
    <div style={{ display: 'flex', background: 'rgba(120,80,200,0.07)', borderRadius: 10, padding: 2, gap: 2 }}>
      {(['ADMIN', 'COACH'] as const).map(r => {
        ...
        return (
          ...
          >
            <p style={{ margin: 0, fontSize: 10, fontWeight: 700, color: active ? ROLE_COLOR[r] : '#8E87A8', transition: 'color 0.15s', fontFamily: 'Carlito, sans-serif' }}>
              {ROLE_LABEL[r]}
            </p>
          </motion.button>
        );
      ...
      <div style={{ padding: '12px 16px 80px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }}>
          ...
          <motion.button
            ...
            style={{
              ...
              fontSize: 12, fontWeight: 700, fontFamily: 'Carlito, sans-serif',
        ...
        <AnimatePresence>
          {showNew && (
            ...
            >
              <p style={{ margin: '0 0 14px', fontSize: 13, fontWeight: 700, color: '#1A1028', fontFamily: 'Cascadia Code, monospace' }}>
                Nuevo club
              </p>
              {[
              ...
              <div style={{ display: 'flex', gap: 8, marginTop: 4 }}>
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.97 }}
                  transition={{ duration: 0.12 }}
                  style={{ flex: 2, padding: '11px 0', borderRadius: 12, border: 'none', background: saving ? '#A855F7' : '#7C3AED', color: '#fff', fontSize: 12, fontWeight: 700, cursor: 'pointer', fontFamily: 'Carlito, sans-serif', boxShadow: '0 3px 14px rgba(124,58,237,0.28)', opacity: (!newForm.clubName || !newForm.adminEmail || !newForm.adminName) ? 0.6 : 1 }}
                >
            ...
            {clubs.map(club => (
              ...
              >
                ...
                {editId === club.id ? (
                  ...
                  >
                    <p style={{ margin: '0 0 12px', fontSize: 12, fontWeight: 700, color: '#7C3AED', fontFamily: 'Cascadia Code, monospace' }}>
                      Editar club
                    </p>
                    {[
                      { label: 'Nombre del club',  key: 'clubName',   type: 'text',  placeholder: 'Ej: Club Patinaje Norte' },
                      ...
                      <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap' }}>
                        {[15, 30, 60].map(d => (
                          <motion.button key={d}
                            ...
                            style={{ padding: '4px 10px', borderRadius: 99, fontSize: 10, fontWeight: 700, cursor: 'pointer', border: editForm.trialDays === String(d) ? 'none' : '1px solid rgba(255,183,3,0.30)', background: editForm.trialDays === String(d) ? '#FFB703' : 'transparent', color: editForm.trialDays === String(d) ? '#fff' : '#B88A00', fontFamily: 'Carlito, sans-serif' }}>
                            +{d} días
                          </motion.button>
                        ))}
                        <motion.button
                          ...
                          whileTap={{ scale: 0.95 }} transition={{ duration: 0.1 }}
                          style={{ padding: '4px 10px', borderRadius: 99, fontSize: 10, fontWeight: 700, cursor: 'pointer', border: editForm.trialDays === '0' ? 'none' : '1px solid rgba(239,71,111,0.25)', background: editForm.trialDays === '0' ? '#EF476F' : 'transparent', color: editForm.trialDays === '0' ? '#fff' : '#EF476F', fontFamily: 'Carlito, sans-serif' }}>
                          Limpiar trial
                        </motion.button>
                      </div>
                    ...
                    <div style={{ display: 'flex', gap: 8 }}>
                      ...
                      <motion.button onClick={() => handleEdit(club.id)}
                        ...
                        whileTap={{ scale: 0.97 }} transition={{ duration: 0.12 }}
                        style={{ flex: 2, padding: '10px 0', borderRadius: 12, border: 'none', background: '#7C3AED', color: '#fff', fontSize: 12, fontWeight: 700, cursor: 'pointer', fontFamily: 'Carlito, sans-serif', boxShadow: '0 3px 14px rgba(124,58,237,0.28)', opacity: !editForm.clubName.trim() ? 0.6 : 1 }}>
                        Guardar cambios
                      </motion.button>
                    </div>
                  </motion.div>
                  ...
                  <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 10 }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: 10, flex: 1, minWidth: 0 }}>
                      <div style={{ width: 48, height: 48, borderRadius: '50%', background: 'rgba(124,58,237,0.10)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 18, fontWeight: 800, color: '#7C3AED', fontFamily: 'Cascadia Code, monospace', flexShrink: 0, overflow: 'hidden' }}>
                        {club.logoUrl
                ...
                <div style={{ display: 'flex', gap: 6, marginBottom: membersClubId === club.id ? 10 : 0 }}>
                  <motion.button
                    ...
                    style={{ flex: 1, padding: '8px 0', borderRadius: 10, border: `1px solid ${membersClubId === club.id ? 'rgba(124,58,237,0.40)' : 'rgba(124,58,237,0.18)'}`, background: membersClubId === club.id ? 'rgba(124,58,237,0.10)' : 'transparent', color: '#7C3AED', fontSize: 11, fontWeight: 700, cursor: 'pointer', fontFamily: 'Carlito, sans-serif', transition: 'all 0.15s' }}
                  >
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.96 }} transition={{ duration: 0.12, ease: EASE }}
                    style={{ flex: 1, padding: '8px 0', borderRadius: 10, border: `1px solid ${club.active ? 'rgba(255,183,3,0.28)' : 'rgba(6,214,160,0.28)'}`, background: club.active ? 'rgba(255,183,3,0.07)' : 'rgba(6,214,160,0.07)', color: club.active ? '#FFB703' : '#06D6A0', fontSize: 11, fontWeight: 700, cursor: 'pointer', fontFamily: 'Carlito, sans-serif', transition: 'all 0.15s' }}
                  >
                    ...
                    >
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '10px 12px', background: 'rgba(124,58,237,0.05)', borderBottom: '1px solid rgba(120,80,200,0.08)' }}>
                        ...
                        <motion.button
                          ...
                          style={{ padding: '4px 10px', borderRadius: 8, background: showAddMember ? 'rgba(239,71,111,0.10)' : '#7C3AED', border: showAddMember ? '1px solid rgba(239,71,111,0.25)' : 'none', color: showAddMember ? '#EF476F' : '#fff', fontSize: 10, fontWeight: 700, cursor: 'pointer', fontFamily: 'Carlito, sans-serif', transition: 'all 0.15s' }}
                        >
                          ...
                          >
                            ...
                            <div style={{ display: 'flex', gap: 8 }}>
                              <motion.button
                                ...
                                whileTap={{ scale: 0.97 }} transition={{ duration: 0.12 }}
                                style={{ flex: 1, padding: '9px 0', borderRadius: 10, border: '1.5px solid rgba(120,80,200,0.15)', background: 'transparent', color: '#8E87A8', fontSize: 11, fontWeight: 600, cursor: 'pointer', fontFamily: 'Carlito, sans-serif' }}
                              >
                                Cancelar
                              </motion.button>
                              <motion.button
                                ...
                                whileTap={{ scale: 0.97 }} transition={{ duration: 0.12 }}
                                style={{ flex: 2, padding: '9px 0', borderRadius: 10, border: 'none', background: memberSaving ? '#A855F7' : '#7C3AED', color: '#fff', fontSize: 11, fontWeight: 700, cursor: 'pointer', fontFamily: 'Carlito, sans-serif', boxShadow: '0 2px 10px rgba(124,58,237,0.25)' }}
                              >
