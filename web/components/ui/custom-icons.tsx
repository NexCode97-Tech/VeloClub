 ...
 * Hoy: el sol.
 *
 * Mismo margen de dos unidades por lado que sus dos vecinos de la fila de
 * Inicio. Aquí importa el doble: los rayos tocan los cuatro bordes del lienzo,
 * así que sin ese aire se recortarían los cuatro.
 */
export function IconHoy({ className, style, ...props }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="-2 -2 28 28" fill="currentColor"
      className={className} style={style} {...props}>
