    ...
    <div style={{ display: 'flex', background: 'rgba(120,80,200,0.07)', borderRadius: 12, padding: 3, gap: 2 }}>
      {PLAN_OPTIONS.map(opt => {
        ...
        return (
          ...
          >
            <p style={{ margin: 0, fontSize: 11, fontWeight: 700, color: active ? '#fff' : '#8E87A8', fontFamily: 'inherit', transition: 'color 0.18s' }}>
              {opt.label}
            </p>
    ...
    <div style={{ display: 'flex', gap: 6 }}>
      {(Object.entries(ESTADO) as [EstadoPago, typeof ESTADO[EstadoPago]][]).map(([k, s]) => {
        ...
        return (
          ...
          >
            <p style={{ margin: 0, fontSize: 10, fontWeight: 700, color: active ? s.color : '#8E87A8', transition: 'color 0.15s', fontFamily: 'inherit' }}>
              {s.label}
            </p>
          </motion.button>
        );
      ...
      <div style={{ padding: '16px 16px 100px' }}>
        ...
        >
          {[
            ...
            <motion.div key={s.label} variants={fadeUp}
              ...
              <p style={{ margin: 0, fontSize: 13, fontWeight: 800, color: s.color, fontFamily: 'inherit', lineHeight: 1 }}>{s.value}</p>
        ...
        {clubs.length === 0 && (
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.28, ease: EASE }}
            ...
            <p style={{ margin: 0, fontSize: 14, fontWeight: 700, color: '#1A1028', fontFamily: 'inherit' }}>Sin clubs registrados</p>
        ...
        <motion.div variants={stagger} initial="hidden" animate="show"
          className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3 sm:gap-4 items-start">
          {clubs.map(c => {
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 3 }}>
                        <p style={{ margin: 0, fontSize: 15, fontWeight: 700, color: '#1A1028', fontFamily: 'inherit', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                          {c.name}
                        </p>
                        {sus && (
                      ...
                      {editPlanId === c.id ? (
                        ...
                        >
                          <span style={{ fontSize: 12, color: sus ? '#5A5278' : '#8E87A8', fontFamily: 'inherit' }}>
                    ...
                    {!sus && trial && (
                      <div style={{ textAlign: 'center', flexShrink: 0 }}>
                        <p style={{ margin: 0, fontSize: 24, fontWeight: 800, color: trial.color, fontFamily: 'inherit', lineHeight: 1 }}>{trial.daysLeft}</p>
                      ...
                      <AnimatePresence>
                        {trial.urgent && (
                          <motion.a
                            ...
                            style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 7, marginTop: 10, padding: '9px 0', borderRadius: 12, background: 'rgba(37,211,102,0.10)', border: '1.5px solid rgba(37,211,102,0.30)', color: '#1BA147', textDecoration: 'none', fontSize: 12, fontWeight: 700, fontFamily: 'inherit', cursor: 'pointer' }}
                            whileTap={{ scale: 0.97 }}
                          >
                                ...
                                >
                                  ...
                                  {(() => {
                                    ...
                                    return (
                                      <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 12, padding: '8px 10px', borderRadius: 10, background: s.bg, border: `1px solid ${s.border}` }}>
                                        ...
                                        <p style={{ margin: 0, fontSize: 11, fontWeight: 600, color: s.color, fontFamily: 'inherit' }}>
                                  ...
                                  <div style={{ display: 'flex', gap: 8 }}>
                                    ...
                                    <motion.button onClick={saveEditPago} disabled={savingEdit} whileTap={{ scale: 0.97 }}
                                      style={{ flex: 2, padding: '10px 0', borderRadius: 12, border: 'none', background: '#7C3AED', color: '#fff', fontSize: 12, fontWeight: 700, cursor: 'pointer', fontFamily: 'inherit', boxShadow: '0 3px 12px rgba(124,58,237,0.28)' }}>
                    ...
                    {abonoOpen === c.id ? (
                      ...
                      >
                        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 14 }}>
                          <p style={{ margin: 0, fontSize: 13, fontWeight: 700, color: '#1A1028', fontFamily: 'inherit' }}>Registrar abono</p>
                      ...
                      <motion.button key="btn"
                        ...
                        style={{ width: '100%', padding: '12px 0', borderRadius: 14, border: 'none', background: 'linear-gradient(135deg,#7C3AED,#4361EE)', color: '#fff', fontSize: 13, fontWeight: 700, cursor: 'pointer', fontFamily: 'inherit', boxShadow: '0 4px 16px rgba(124,58,237,0.28)', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6 }}>
        ...
        {receiptModal && (
          <>
            ...
            >
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 14 }}>
                <div>
                  <p style={{ margin: 0, fontSize: 14, fontWeight: 700, color: '#1A1028', fontFamily: 'inherit' }}>
                    Comprobante de pago
                  </p>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                ...
                {receiptFile && (
                  <motion.button
                    ...
                    whileTap={{ scale: 0.97 }}
                    style={{ width: '100%', padding: '12px 0', borderRadius: 12, border: 'none', background: uploadingReceipt ? '#A855F7' : '#7C3AED', color: '#fff', fontSize: 13, fontWeight: 700, cursor: 'pointer', fontFamily: 'inherit', boxShadow: '0 3px 14px rgba(124,58,237,0.30)' }}
                  >
                ...
                {receiptModal.receiptUrl && !receiptFile && (
                  <motion.button
                    ...
                    whileTap={{ scale: 0.97 }}
                    style={{ width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6, padding: '11px 0', borderRadius: 12, border: '1.5px solid rgba(6,214,160,0.30)', background: 'rgba(6,214,160,0.07)', color: '#06D6A0', fontSize: 12, fontWeight: 700, cursor: 'pointer', fontFamily: 'inherit' }}
                  >
                    <Eye size={14} />
                ...
                {receiptModal.receiptUrl && !receiptFile && (
                  <motion.button
                    ...
                    whileTap={{ scale: 0.97 }}
                    style={{ width: '100%', padding: '11px 0', borderRadius: 12, border: '1.5px solid rgba(239,71,111,0.22)', background: 'rgba(239,71,111,0.06)', color: '#EF476F', fontSize: 12, fontWeight: 700, cursor: 'pointer', fontFamily: 'inherit' }}
                  >
