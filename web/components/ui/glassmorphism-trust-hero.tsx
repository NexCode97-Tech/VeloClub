...
export default function GlassmorphismHero() {
  return (
    <div className="relative w-full bg-zinc-950 text-white overflow-hidden font-sans">
      ...
      {/* Imagen deportista silueta de espalda */}
      <div
      ...
      {/* Puerta violeta — radial glow centrado en la figura */}
      <div
        className="absolute inset-0 z-[1] pointer-events-none"
        style={{
          background: 'radial-gradient(ellipse 380px 600px at 42% 62%, rgba(124,58,237,0.75) 0%, rgba(109,28,209,0.45) 35%, rgba(168,85,247,0.15) 60%, transparent 80%)',
        }}
      />

      {/* Oscurecimiento lateral derecho para que las cards destaquen */}
      <div
        className="absolute inset-0 z-[1] pointer-events-none"
        style={{
          background: 'linear-gradient(to right, transparent 40%, rgba(9,4,20,0.6) 100%)',
        }}
      />
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:gap-8 items-start">
          ...
          <div className="lg:col-span-7 flex flex-col justify-center space-y-8 pt-8">
            ...
            <div className="animate-fade-in delay-400 flex flex-col sm:flex-row gap-4">
              <Link
                href="/sign-in"
                className="group inline-flex items-center justify-center gap-2 rounded-full px-8 py-4 text-sm font-semibold text-white transition-all hover:scale-[1.02] active:scale-[0.98]"
              ...
              >
                <div className="animate-marquee flex gap-12 whitespace-nowrap px-4">
                  {[...SPORTS, ...SPORTS, ...SPORTS].map((sport, i) => (
                    ...
                    >
                      <sport.icon className="h-6 w-6 text-violet-400" />
