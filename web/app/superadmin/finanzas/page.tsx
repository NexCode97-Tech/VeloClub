    ...
    <div style={{ display: 'flex', background: 'rgba(120,80,200,0.07)', borderRadius: 12, padding: 3, gap: 2 }}>
      {PLAN_OPTIONS.map(opt => {
        ...
        return (
          ...
          >
            <p style={{ margin: 0, fontSize: 11, fontWeight: 700, color: active ? '#fff' : '#8E87A8', fontFamily: 'Open Sans, sans-serif', transition: 'color 0.18s' }}>
              {opt.label}
            </p>
    ...
    <div style={{ display: 'flex', gap: 6 }}>
      {(Object.entries(ESTADO) as [EstadoPago, typeof ESTADO[EstadoPago]][]).map(([k, s]) => {
        ...
        return (
          ...
          >
            <p style={{ margin: 0, fontSize: 10, fontWeight: 700, color: active ? s.color : '#8E87A8', transition: 'color 0.15s', fontFamily: 'Open Sans, sans-serif' }}>
              {s.label}
            </p>
          </motion.button>
        );
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      {editPlanId === c.id ? (
                        ...
                        >
                          <span style={{ fontSize: 12, color: sus ? '#5A5278' : '#8E87A8', fontFamily: 'Open Sans, sans-serif' }}>
                      ...
                      <AnimatePresence>
                        {trial.urgent && (
                          <motion.a
                            ...
                            style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 7, marginTop: 10, padding: '9px 0', borderRadius: 12, background: 'rgba(37,211,102,0.10)', border: '1.5px solid rgba(37,211,102,0.30)', color: '#1BA147', textDecoration: 'none', fontSize: 12, fontWeight: 700, fontFamily: 'Open Sans, sans-serif', cursor: 'pointer' }}
                            whileTap={{ scale: 0.97 }}
                          >
                                ...
                                >
                                  ...
                                  {(() => {
                                    ...
                                    return (
                                      <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 12, padding: '8px 10px', borderRadius: 10, background: s.bg, border: `1px solid ${s.border}` }}>
                                        ...
                                        <p style={{ margin: 0, fontSize: 11, fontWeight: 600, color: s.color, fontFamily: 'Open Sans, sans-serif' }}>
                                  ...
                                  <div style={{ display: 'flex', gap: 8 }}>
                                    ...
                                    <motion.button onClick={saveEditPago} disabled={savingEdit} whileTap={{ scale: 0.97 }}
                                      style={{ flex: 2, padding: '10px 0', borderRadius: 12, border: 'none', background: '#7C3AED', color: '#fff', fontSize: 12, fontWeight: 700, cursor: 'pointer', fontFamily: 'Open Sans, sans-serif', boxShadow: '0 3px 12px rgba(124,58,237,0.28)' }}>
                  ...
                  <AnimatePresence mode="wait">
                    {abonoOpen === c.id ? (
                      ...
                      >
                        ...
                        <div style={{ display: 'flex', gap: 8 }}>
                          ...
                          <motion.button
                            ...
                            style={{ flex: 2, padding: '11px 0', borderRadius: 12, border: 'none', cursor: saving || saveSuccess ? 'default' : 'pointer', fontFamily: 'Open Sans, sans-serif', fontWeight: 700, fontSize: 12, color: '#fff', boxShadow: saveSuccess ? '0 4px 14px rgba(6,214,160,0.40)' : '0 4px 14px rgba(124,58,237,0.32)', background: saveSuccess ? '#06D6A0' : 'linear-gradient(135deg,#7C3AED,#4361EE)', transition: 'background 0.3s, box-shadow 0.3s', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6 }}>
                      ...
                      <motion.button key="btn"
                        ...
                        style={{ width: '100%', padding: '12px 0', borderRadius: 14, border: 'none', background: 'linear-gradient(135deg,#7C3AED,#4361EE)', color: '#fff', fontSize: 13, fontWeight: 700, cursor: 'pointer', fontFamily: 'Open Sans, sans-serif', boxShadow: '0 4px 16px rgba(124,58,237,0.28)', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6 }}>
            ...
            >
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                ...
                <label style={{ display: 'block', cursor: 'pointer' }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, padding: '11px 0', borderRadius: 12, border: '1.5px solid rgba(124,58,237,0.25)', background: 'rgba(124,58,237,0.05)', color: '#7C3AED', fontSize: 12, fontWeight: 700, fontFamily: 'Open Sans, sans-serif' }}>
                ...
                {receiptFile && (
                  <motion.button
                    ...
                    whileTap={{ scale: 0.97 }}
                    style={{ width: '100%', padding: '12px 0', borderRadius: 12, border: 'none', background: uploadingReceipt ? '#A855F7' : '#7C3AED', color: '#fff', fontSize: 13, fontWeight: 700, cursor: 'pointer', fontFamily: 'Open Sans, sans-serif', boxShadow: '0 3px 14px rgba(124,58,237,0.30)' }}
                  >
                ...
                {receiptModal.receiptUrl && !receiptFile && (
                  <motion.button
                    ...
                    whileTap={{ scale: 0.97 }}
                    style={{ width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6, padding: '11px 0', borderRadius: 12, border: '1.5px solid rgba(6,214,160,0.30)', background: 'rgba(6,214,160,0.07)', color: '#06D6A0', fontSize: 12, fontWeight: 700, cursor: 'pointer', fontFamily: 'Open Sans, sans-serif' }}
                  >
                    <Eye size={14} />
                ...
                {receiptModal.receiptUrl && !receiptFile && (
                  <motion.button
                    ...
                    whileTap={{ scale: 0.97 }}
                    style={{ width: '100%', padding: '11px 0', borderRadius: 12, border: '1.5px solid rgba(239,71,111,0.22)', background: 'rgba(239,71,111,0.06)', color: '#EF476F', fontSize: 12, fontWeight: 700, cursor: 'pointer', fontFamily: 'Open Sans, sans-serif' }}
                  >
