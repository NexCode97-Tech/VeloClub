    ...
    <div style={{ background: '#F7F7FB', minHeight: '100%' }}>
      ...
      <div style={{ padding: '20px 20px 14px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <h1 style={{ margin: 0, fontSize: 24, fontWeight: 800, color: '#1A1028', lineHeight: 1.1, fontFamily: 'Poppins, sans-serif' }}>
            Panel Global
          </h1>
      ...
      >
        ...
        >
          ...
          <div style={{ display: 'flex', alignItems: 'baseline', gap: 2, marginBottom: 6 }}>
            <span style={{ fontSize: 48, fontWeight: 800, color: '#1A1028', fontFamily: 'Poppins, sans-serif', lineHeight: 1 }}>
              {heroFmt.main}
            </span>
            {heroFmt.suffix && (
              <span style={{ fontSize: 36, fontWeight: 700, color: '#C4BFD8', fontFamily: 'Poppins, sans-serif', lineHeight: 1 }}>
                {heroFmt.suffix}
              </span>
            )}
          </div>
        ...
        >
          <div style={{ background: '#fff', borderRadius: 20, padding: '16px 14px', border: '1px solid rgba(120,80,200,0.10)', boxShadow: '0 2px 12px rgba(124,58,237,0.05)' }}>
            ...
            <p style={{ margin: '0 0 4px', fontSize: 44, fontWeight: 800, color: '#1A1028', fontFamily: 'Poppins, sans-serif', lineHeight: 1 }}>
        ...
        >
          {[
            ...
            <div key={s.label} style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '14px 16px', borderBottom: i < 2 ? '1px solid rgba(120,80,200,0.07)' : 'none' }}>
              ...
              <p style={{ margin: 0, fontSize: 22, fontWeight: 800, color: s.color, fontFamily: 'Poppins, sans-serif', lineHeight: 1 }}>{s.value}</p>
            </div>
          ))}
        </motion.div>
        ...
        {hasIncomeData && (
          ...
          >
            <div style={{ padding: '16px 16px 0' }}>
              <p style={{ margin: '0 0 1px', fontSize: 13, fontWeight: 700, color: '#1A1028', fontFamily: 'Poppins, sans-serif' }}>Ingresos por mes</p>
                ...
                return (
                  <Link key={club.id} href="/superadmin/clubs" style={{ textDecoration: 'none' }}>
                    <div style={{ background: '#fff', border: '1px solid rgba(120,80,200,0.10)', borderRadius: 16, display: 'flex', alignItems: 'center', gap: 12, padding: '12px 14px', cursor: 'pointer' }}>
                      <div style={{ width: 48, height: 48, borderRadius: '50%', background: 'rgba(124,58,237,0.10)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 18, fontWeight: 800, color: '#7C3AED', fontFamily: 'Poppins, sans-serif', flexShrink: 0, overflow: 'hidden' }}>
                        {club.logoUrl
