              ...
              <div className="relative h-full flex flex-col justify-between p-5">
                ...
                <div>
                  ...
                  <p className="text-[32px] font-extrabold leading-none tracking-tight"
                    style={{ fontFamily: "'Open Sans', sans-serif", textShadow: '0 2px 8px rgba(0,0,0,0.2)' }}>
                    ...
                    {clubPlan ? (() => {
                      ...
                      return (
                        <>
                          ...
                          <p className="text-[12px] font-bold opacity-90" style={{ fontFamily: "'Open Sans', sans-serif" }}>
                            Vence {venceStr}
                          </p>
                        </>
                      );
            ...
            <div className="grid grid-cols-3 gap-2 md:gap-3 md:h-full">
              {([
                ...
                return (
                  ...
                  >
                    <p className="text-[22px] md:text-[48px] font-extrabold leading-none" style={{ fontFamily: "'Open Sans', sans-serif", color }}>{value}</p>
            ...
            <div className="grid grid-cols-3 gap-2">
              {[
                ...
                <div key={label} className="bg-white border border-border rounded-xl p-3 text-center">
                  ...
                  <p className="text-[11px] font-extrabold text-foreground" style={{ fontFamily: "'Open Sans', sans-serif" }}>
                    {fmt.format(value)}
                  </p>
