    ...
    <div style={{ background: '#F7F7FB', minHeight: '100%' }}>
      ...
      <div style={{ padding: '20px 20px 14px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <h1 style={{ margin: 0, fontSize: 24, fontWeight: 800, color: '#1A1028', lineHeight: 1.1, fontFamily: 'Space Grotesk, sans-serif' }}>
            Panel Global
          </h1>
      ...
      >
        ...
        >
          ...
          <div style={{ display: 'flex', alignItems: 'baseline', gap: 2, marginBottom: 6 }}>
            ...
            {heroFmt.suffix && (
              <span style={{ fontSize: 36, fontWeight: 700, color: '#C4BFD8', fontFamily: 'Space Grotesk, sans-serif', lineHeight: 1 }}>
                {heroFmt.suffix}
              </span>
            )}
          </div>
